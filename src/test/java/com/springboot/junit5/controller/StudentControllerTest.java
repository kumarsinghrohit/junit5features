...
import com.springboot.junit5.service.StudentService;
...
//		String expected = "{id:Course1,name:Spring,description:10 Steps}";
    ...
    public void testJsonController() throws Exception {
        ...
        String courseNanme = "BDD";
        RequestBuilder builder = MockMvcRequestBuilders.put("/updateStudent/" + studentId + "/" + courseId + "/" + courseNanme)
                .accept(MediaType.APPLICATION_JSON).content(exampleCourseJson)
                .contentType(MediaType.APPLICATION_JSON);
        
        // studentService.addCourse to respond back with mockCourse
        Mockito.when(
                studentService.updateCourse(Mockito.anyString(),
